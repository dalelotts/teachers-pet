...
If you are submitting a bug for the app, please include a unit, integration, or acceptance test that demonstrates the issue.
...
```shell
git clone https://github.com/dalelotts/teachers-pet.git
cd teachers-pet
npm install
...
We'd love for you to contribute to our source code and to make teachers-pet even better than it is
...
If you have questions about how to use teachers-pet, please direct these to the [Gitter Chat Group][gitter].
...
In GitHub, send a pull request to `teachers-pet:develop`.
...
we use the git commit messages to **generate the teachers-pet change log**.
...
[github]: https://github.com/dalelotts/teachers-pet
[gitter]: https://gitter.im/dalelotts/teachers-pet
[issues]: https://github.com/dalelotts/teachers-pet/issues
[pulls]: https://github.com/dalelotts/teachers-pet/pulls
